...
export const RichTextComponent = {
    ...
    block: {
        h1: ({ children }: any) => (
            <h1 className='py-10 text-5xl uppercase font-bold'>{children}</h1>
        ),
        h2: ({ children }: any) => (
            <h1 className='py-10 text-4xl font-bold'>{children}</h1>
        ),
        h3: ({ children }: any) => (
            <h1 className='py-10 text-3xl uppercase font-bold'>{children}</h1>
        ),
        h4: ({ children }: any) => (
    ...
    marks: {
        ...
        em: ({ children }: any) => <em className='font-bold'>{children}</em>,
    },
};
